...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataList.add(MyItem(R.drawable.sample_2, "Daisy", "010.0000.0001", false))
        ...
        dataList.add(MyItem(R.drawable.sample_5, "Happy", "010.0000.0004", false))
        dataList.add(MyItem(R.drawable.sample_6, "Luna", "010.0000.0005", false))
        dataList.add(MyItem(R.drawable.sample_7, "Bob", "010.0000.0006", false))
